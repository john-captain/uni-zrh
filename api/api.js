...
export function getDetail(params) {
	return request.get("v3/bond/item", params, {
		noAuth: true
	});
}
/**
...
export function getSearchList(params) {
	return request.get("v3/bond/search", params, {
		noAuth: true
	});
}
/**
 ...
 * @returns {*}
 */
export function getHomeNavTitle() {
	return request.get("/v3/bond/nav", {}, {
		noAuth: true
	});
}
 ...
 * @returns {*}
 */
export function getHomeBondList(params) {
	return request.get("/v3/bond/lst", params, {
		noAuth: true
	});
}
