		  ...
		  <view class="weui-grids">
			...
			<view class="weui-grid" >
		      <navigator url="..此处是你的连接">
		        ...
		        <text class="weui-grid__label">发布逆回购</text>
			...
			<view class="weui-grid" >
		      <navigator url="..此处是你的连接">
		        ...
		        <text class="weui-grid__labe2">发布正回购</text>
			...
			<view class="weui-grid" >
		      <navigator url="..此处是你的连接">
		        ...
		        <text class="weui-grid__labe3">发布bid</text>
			...
			<view class="weui-grid" >
		      <navigator url="..此处是你的连接">
		        ...
		        <text class="weui-grid__labe4">发布ofr</text>
